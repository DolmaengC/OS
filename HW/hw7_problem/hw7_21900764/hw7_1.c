...
int main(int argc, char *argv[])
{
	...
	*/
	...
	// updated
	/*
	 if sb.count == 0 and Consumer's flow passed if statement of while,
	 then "sem_wait(param->p_full)" wait forever.
	 So I sould insert dummy string for terminate consumer

	 else if sb.count != 0 and Producer's flow passed if statement of while and buffer is full,
	 then "sem_wait(param->p_empty)" wait forever.
	 So I sould delete a string for terminate producer
	*/
